    ...
    <>
            ...
            <ul className="thq-flex-column">
              <li className="content-list1-li list-item thq-flex-column">
                ...
                <p className="content-list1-content1 thq-body-small">
                  <span>Effective date: May 13nd, 2024</span>
                  ...
                  <br></br>
                  <span>
                    I. INFORMATION COLLECTION AND USE We collect several
                    different types of information for various purposes to
                  ...
                  <br></br>
                  <span>Email address Cookies and Usage Data</span>
                  ...
                  <span>
                    ...
                    disclose your Personal Data in the good faith belief that
                  ...
                  <br></br>
                  <span>
                    V. SECURITY OF DATA The security of your data is important
                  ...
                  <br></br>
                  <span>
                    VI. SERVICE PROVIDERS We may employ third party companies
                  ...
                  <br></br>
                  <span>
                    Analytics We may use third-party Service Providers to
                  ...
                  <span>
                    ...
                    Policy from time to time. We will notify you of any changes
                  ...
                  <br></br>
                  <span>Email: Contact@witwhisker.com</span>
      ...
      <style jsx>
        {`
          ...
          .content-list1-text004 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text007 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text010 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text013 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text016 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text019 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text022 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text025 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text028 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text031 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text034 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text037 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text040 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text043 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text046 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text049 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text052 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text055 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text058 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text061 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text064 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text067 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text070 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text073 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text076 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text079 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text082 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text085 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text088 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text091 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text094 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text097 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text100 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text103 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text106 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text109 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
          .content-list1-text112 {
            color: #504f4f;
            font-size: 12px;
            font-family: 'Star Cartoon';
          }
