...
const Footer12 = (props) => {
  return (
    <>
      <div className="footer12-footer1 thq-section-padding">
          ...
          <div className="footer12-content">
            ...
            <div className="footer12-links">
              ...
              <div className="footer12-column2">
                <strong className="thq-body-large footer12-column2-title">
                  {props.column2Title}
                </strong>
...
Footer12.defaultProps = {
  socialLink2: 'https://www.instagram.com/whiskercrypto/',
  socialLink4: 'https://www.facebook.com/WhiskerCrypto/',
  action1: 'Subscribe',
  link7: 'Contact Us',
  termsLink: '#',
  cookiesLink: '#',
  ...
  link5: 'Tokenomics',
  socialLink3: 'https://www.linkedin.com/company/whiskercrypto/',
  socialLink5: 'https://www.reddit.com/r/WhiskerCrypto/',
  link3: 'NFT Collections',
  content3: '© 2024 TeleportHQ',
  socialLink1Title: 'Twitter',
  content2:
    'By subscribing you agree to with our Privacy Policy and provide consent to receive updates from our company.',
  image1Src:
    'https://images.unsplash.com/photo-1465443313160-ebeac85f54d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxNTYxODAzM3w&ixlib=rb-4.0.3&q=80&w=1080',
  column1Title: 'Company',
  image1Alt: 'Whisker Logo',
  link6: 'Partnerships',
